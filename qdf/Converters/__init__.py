...
from xarray import open_dataset, Dataset, open_dataarray, DataArray
from qdf.Formalizer import DatasetCompiler

class QQAdapter(ABC):
    """ QM, Qblox dataset bidirectional transformer. """
    def __init__(self, filepath_or_dataset:str|Dataset, exp_name:str):
        ...
        self.__new_dataset_path:str = "TBD"
        self.settings(filepath_or_dataset, exp_name)
    ...
    def settings(self, filepath_or_dataset:str|Dataset, exp_name:str):
        ...
        elif isinstance(filepath_or_dataset, (Dataset, DataArray)):
...
if __name__ == "__main__":
    d = open_dataarray("TestRawDataset/QM_rawdata/detuned_time_rabi/AVG/detuned_time_rabi_new.nc")
    print(d)
