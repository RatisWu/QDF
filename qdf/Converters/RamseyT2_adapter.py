...
class RamseyT2_dataConverter(QQAdapter):
...
if __name__ == "__main__":
    # # QM 
    # # average
    path = "TestRawDataset/QM_rawdata/ramseyT2/AVG/ramseyT2_stat_new.nc"
    # # Qblox
    # # average
    # path = "TestRawDataset/Qblox_rawdata/Ramsey/AVG/Ramsey_20250220142032_new.nc"
    # # Shot
    # path = "TestRawDataset/Qblox_rawdata/Ramsey/Shot/Ramsey_20250220142556_new.nc"
    
    Cnvtr = RamseyT2_dataConverter(file_path_or_dataset=path)
